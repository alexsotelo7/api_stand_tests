...
class LoginPageAround:
    ...
    registrer_in_button = (By.CLASS_NAME, 'header__auth-link')
    ...
    def click_registration_button(self):
        self.driver.find_element(*self.registrer_in_button).click()

    # El método valida el texto en el botón Registrarse
    def check_text_registration_button(self):
        registration_button_text = self.driver.find_element(*self.registrer_in_button).text
